...
Keys are read from environment variables at startup:
    API_KEY_CORPUS              — key for the corpus service itself
    API_KEY_BACKEND             — key for the main backend service
    API_KEY_SENTENCE_PROCESSOR  — key for the sentence processor service
"""
import os
...
VALID_API_KEYS: set[str] = set(filter(None, [
